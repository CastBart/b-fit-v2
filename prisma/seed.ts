...
async function main() {
  ...
  const chestExercises = [
    ...
    },
    {
      ...
      primaryMuscleGroup: MuscleGroup.CHEST,
      secondaryMuscleGroups: [MuscleGroup.TRICEPS, MuscleGroup.SHOULDERS, MuscleGroup.CORE],
  ...
  const cardioExercises = [
    ...
    },
    {
      ...
      primaryMuscleGroup: MuscleGroup.FULL_BODY,
      secondaryMuscleGroups: [MuscleGroup.BACK, MuscleGroup.QUADS],
      equipmentType: EquipmentType.CARDIO_EQUIPMENT,
      movementPattern: MovementPattern.PULL,
      difficultyLevel: DifficultyLevel.BEGINNER,
      exerciseType: ExerciseType.CARDIO,
    ...
    },
    {
      ...
      primaryMuscleGroup: MuscleGroup.GLUTES,
      secondaryMuscleGroups: [MuscleGroup.HAMSTRINGS, MuscleGroup.BACK, MuscleGroup.CORE],
    ...
    },
    {
      ...
      primaryMuscleGroup: MuscleGroup.FULL_BODY,
      secondaryMuscleGroups: [MuscleGroup.CORE, MuscleGroup.SHOULDERS],
      equipmentType: EquipmentType.DUMBBELL,
      movementPattern: MovementPattern.CARRY,
      difficultyLevel: DifficultyLevel.BEGINNER,
      exerciseType: ExerciseType.MEDIUM,
  ...
  const olympicExercises = [
    {
      ...
      primaryMuscleGroup: MuscleGroup.FULL_BODY,
      secondaryMuscleGroups: [MuscleGroup.BACK, MuscleGroup.QUADS, MuscleGroup.SHOULDERS],
      equipmentType: EquipmentType.BARBELL,
